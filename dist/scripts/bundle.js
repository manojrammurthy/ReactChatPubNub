...
var ChatBody = React.createClass({displayName: "ChatBody",
	render:function(){
			...
			var messageList = this.props.data.map(function(message,index){
				return(
					React.createElement("div", {className: "items", key: index}, 
					React.createElement("a", {href: "#", className: "pull-left"}, 
			React.createElement("img", {className: "img-thumbnail img-circle", src: message.avatar_url})
			        ), 
			        React.createElement("div", {className: "media-body"}, 
			          React.createElement("p", null, React.createElement("strong", null, "Anonymous robot#", message.uid)), 
			          React.createElement("p", {className: "small"}, React.createElement("span", {className: "glyphicon glyphicon-time"}, message.createdTime)), 
		...
		return (
				React.createElement("div", {className: "container", id: "conHeight"}, 
    				messageList		 	
  				)
...
var ChatForm = React.createClass({displayName: "ChatForm",
	...
	render:function(){
			...
			var avatar_url = "http://robohash.org/" + this.props.user + "?set=set2&bgset=bg2&size=70x70";
		return (
				React.createElement("div", {className: "message-form", id: "footer"}, 
				React.createElement("div", {className: "container"}, 
				React.createElement("div", {className: "row"}, 
				React.createElement("form", {role: "form", style: {padding: 20 + 'px'}, onSubmit: this.handleSubmit}, 
				React.createElement("div", {className: "input-field col-lg-6"}, 
				    React.createElement("div", {className: "form-group "}, 
				    React.createElement("span", {className: "glyphicon glyphicon-pencil"}), 
				      React.createElement("input", {type: "text", className: "line-form", ref: "Message", placeholder: "Type your message"})
				    )	
				), 
				React.createElement("div", {className: "col-sm-4"}, 
					React.createElement("button", {id: "btn", type: "submit", className: " btn btn-default btn-lg"}, React.createElement("i", {className: "glyphicon glyphicon-send"}, "send"))
				)			
				)			   
				), 
				React.createElement("span", {className: "chip pull-left"}, 
          			React.createElement("img", {className: "img-circle", src: avatar_url, style: {height: 30 + 'px', width: 30 + 'px'}}), 
 ...
 render:function(){
		return (
			React.createElement("div", null, 
				React.createElement(ErrorDisplay, {error: this.state.errors}), 
