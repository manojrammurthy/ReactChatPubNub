...
var ChatForm = React.createClass({displayName: "ChatForm",
	...
	render:function(){
		...
		return (
				...
				React.createElement("form", {role: "form", style: {padding: 30 + 'px'}, onSubmit: this.handleSubmit}, 
				...
				React.createElement("div", {className: "col-sm-4"}, 
					React.createElement("button", {type: "submit", className: " btn btn-default btn-lg"}, React.createElement("i", {className: "glyphicon glyphicon-send"}, "send"))
				)			
				)			   
				), 
