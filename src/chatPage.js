...
var ChatForm = React.createClass({
	...
	render:function(){
		...
		return (
				...
				<div className="row">
				<form role="form" style={{padding: 20 + 'px'}} onSubmit= {this.handleSubmit} >
				...
				<div className="col-sm-4">
					<button id="btn" type="submit" className=" btn btn-default btn-lg"><i className="glyphicon glyphicon-send">send</i></button>
				</div>			
				</form>			   
				</div>
